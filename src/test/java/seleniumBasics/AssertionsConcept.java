...
public class AssertionsConcept {
	// 1. Hard Assertions (Assert class in TestNG) ==> It will fail the test case
	// immediately if any assertion fails
	// 2. Soft Assertions (SoftAssert class in TestNG) ==> It will not fail the test
	// case immediately if any assertion fails. It will continue the execution of
	// test case. At the end of the test case, we need to call assertAll() method to
	// mark the test case as failed if any assertion failed during the test case
	// execution.
	...
	public static void main(String[] args) {
		...
		softAssert.assertAll(); // This will mark the test case as failed if any assertion failed during the
								// test case execution.
